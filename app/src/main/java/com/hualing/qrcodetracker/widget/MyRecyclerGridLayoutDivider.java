...
public class MyRecyclerGridLayoutDivider extends RecyclerView.ItemDecoration {
    private int space;
    private int color = -1;
    ...
    public MyRecyclerGridLayoutDivider(int space) {
        this.space = space;
    }

    public MyRecyclerGridLayoutDivider(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public MyRecyclerGridLayoutDivider(int space, int color,int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public MyRecyclerGridLayoutDivider(int space, Drawable mDivider) {
        this.space = space;
